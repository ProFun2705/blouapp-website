...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Privacy policy for the Blou quit smoking tracker app and tryblou.com website.",
  path: "/privacy",
});
...
const sections: Section[] = [
  {
    ...
    paragraphs: [
      "Blou is a general wellness and motivation app. The tips, insights, and other content it provides are for informational and motivational support only and are not medical or professional health advice. If you have health concerns or need support with quitting, you should consult a qualified healthcare provider. This policy describes how we collect and use data in providing that wellness support.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "The tryblou.com website uses Google Analytics 4 with IP anonymization to understand aggregate site usage. No personally identifiable information is collected through the website. You can opt out by using standard browser extensions that block analytics or by using private browsing.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Data deletion. If you would like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at ${CONTACT_EMAIL}. They will respond within a reasonable time.`,
    ],
  },
  {
    title: "7. Data retention",
    paragraphs: [
      "The Service Provider will retain User Provided Data for as long as you use the Application and for a reasonable time thereafter. For requests to delete User Provided Data, see section 6 above.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      `If you have reason to believe that a child has provided personally identifiable information to the Service Provider through the Application and/or services, please contact the Service Provider at ${CONTACT_EMAIL} so that they can take the necessary actions.`,
  ...
  },
  {
    title: "12. Contact us",
    paragraphs: [
      `If you have any questions regarding privacy while using the Application, or about the practices described here, please contact the Service Provider via email at ${CONTACT_EMAIL}.`,
    ],
  },
];
  ...
  return (
    <article className="flex flex-col gap-8">
      ...
      <header className="rounded-3xl border border-teal-200/90 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-teal-900/85">
          This privacy policy applies to the Blou app (the &quot;Application&quot;) for
          mobile devices, created by Heorhi Talochka (the &quot;Service Provider&quot;) as
          a commercial service. This service is provided &quot;AS IS&quot;.
        </p>
      </header>
